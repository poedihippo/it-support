...
function TicketViewPeminjamanCreate({ state, dispatch, ticketData, setTitle }) {
            ...
            <div className="row clearfix">
              ...
              <div className="col-sm-12">
                ...
                <div className="form-group">
                  <div className="form-line">
                    <Field
                      as="textarea"
                      disabled={state.userState === "SUPERVISOR" ? false : true}
                      rows="3"
                      className="form-control no-resize"
              ...
              <div className="col-sm-12">
                <div className="form-group">
                  {state.userState === "SUPERVISOR" && values.status === 1 ? (
                    <React.Fragment>
                      <button
                        ...
                        type="button"
                        onClick={() => {
                          approveTicket(2, values, setFieldValue);
                        }}
                      >
                        Approve Ticket
                      </button>
                  ...
                  {(values.status === 1 && state.userState === "USER") ||
...
export default TicketViewPeminjamanCreate;
