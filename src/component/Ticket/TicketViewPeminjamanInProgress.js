...
function TicketViewPeminjamanInProgress({
  state,
  dispatch,
  ticketData,
  setTitle,
  ...
  const shippingDetail = async (
    ...
    try {
      const res = await axios.post(
        `${config.SERVER_URL}ticketpeminjaman/shippingdetail`,
        {
          ticket: values,
          detail: detailData,
          fromStock,
  ...
  const shippingTicket = async (values, setFieldValue) => {
    try {
      const res = await axios.post(
        `${config.SERVER_URL}ticketpeminjaman/shippingticket`,
        {
          ticket: values,
        },
        axiosConfig
  ...
  const assignInventori = async (values, setFieldValue) => {
    ...
    try {
      const res = await axios.post(
        `${config.SERVER_URL}ticketpeminjaman/assigninventori`,
        values,
        axiosConfig
      );
  ...
  const resetInventori = async (detail, setFieldValue) => {
    ...
    try {
      const res = await axios.post(
        `${config.SERVER_URL}ticketpeminjaman/resetinventori`,
        { detail },
        axiosConfig
      );
      setFieldValue("status", res.data.status);
...
export default TicketViewPeminjamanInProgress;
